 ...
 * 歌手标签页
 */
class ArtistFragment : PlaceholderFragment() {
    companion object {
        fun newInstance() = PlaceholderFragment.newInstance("歌手")
    }
}
 ...
 * 专辑标签页
 */
class AlbumFragment : PlaceholderFragment() {
    companion object {
        fun newInstance() = PlaceholderFragment.newInstance("专辑")
    }
}
